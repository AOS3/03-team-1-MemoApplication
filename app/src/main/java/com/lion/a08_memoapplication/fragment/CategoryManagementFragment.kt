...
//    }
    ...
    override fun onCreateView(
        ...
        fragmentCategoryManagementBinding =
            FragmentCategoryManagementBinding.inflate(layoutInflater, container, false)
                ...
                builder.setPositiveButton("등록") { dialogInterface: DialogInterface, i: Int ->
                    ...
                    CoroutineScope(Dispatchers.Main).launch {
                        val work1 = async(Dispatchers.IO) {
                            // 입력한 카텥고리 이름을 가져온다.
                            val categoryName =
                                dialogCategoryManagementBinding.textFieldDialogCategoryManagement.editText?.text.toString()
                            // 저장한다.
    ...
    // RecyclerView의 어뎁터
    inner class RecyclerViewCategoryManagementAdapter :
        RecyclerView.Adapter<RecyclerViewCategoryManagementAdapter.ViewHolderCategoryManagement>() {
        // ViewHolder
        inner class ViewHolderCategoryManagement(val rowCategoryManagementBinding: RowCategoryManagementBinding) :
            RecyclerView.ViewHolder(rowCategoryManagementBinding.root)

        override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
        ): ViewHolderCategoryManagement {
            val rowCategoryManagementBinding =
                RowCategoryManagementBinding.inflate(layoutInflater, parent, false)
            val viewHolderCategoryManagement =
                ViewHolderCategoryManagement(rowCategoryManagementBinding)
            ...
            rowCategoryManagementBinding.buttonRowCategoryManagement.setOnClickListener {
                ...
                categoryManagementBottomSheetFragment.show(
        ...
        override fun onBindViewHolder(holder: ViewHolderCategoryManagement, position: Int) {
            holder.rowCategoryManagementBinding.textViewRowCategoryManagement.text =
