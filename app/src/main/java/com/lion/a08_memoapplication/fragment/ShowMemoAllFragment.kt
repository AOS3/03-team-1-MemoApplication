...
//    }
    ...
    override fun onCreateView(
        ...
        fragmentShowMemoAllBinding =
            FragmentShowMemoAllBinding.inflate(layoutInflater, container, false)
        ...
        if(memoList[position].memoIsSecret){
            ...
            builder.setPositiveButton("확인"){ dialogInterface: DialogInterface, i: Int ->
                ...
                if(inputPassword == memoList[position].memoPassword){
                    ...
                    val snackbar = Snackbar.make(fragmentShowMemoAllBinding.root, "비밀번호를 잘못 입력하였습니다", Snackbar.LENGTH_SHORT)
                    snackbar.show()
                }
            }
            builder.show()
