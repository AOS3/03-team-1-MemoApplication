...
class AddMemoFragment : Fragment() {
    ...
    var categoryIdxList = mutableListOf<Int>()
    ...
    override fun onCreateView(
        ...
        fragmentAddMemoBinding = FragmentAddMemoBinding.inflate(layoutInflater, container, false)
        ...
        Log.e("test100", "MemoName : ${arguments?.getString("MemoName")}")
        // 만약 카테고리를 선택해서 온 것이라면.
        if (arguments?.getString("MemoName") == MemoListName.MEMO_NAME_ADDED.str) {
            Log.e("test100", "${arguments?.getInt("categoryIdx")!!}")
            Log.e("test100", "${arguments?.getString("categoryName")}")
        }
