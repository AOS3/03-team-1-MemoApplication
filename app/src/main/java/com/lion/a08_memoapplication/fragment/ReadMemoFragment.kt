...
class ReadMemoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentReadMemoBinding = FragmentReadMemoBinding.inflate(layoutInflater, container, false)
                ...
                when (it.itemId) {
                    ...
                    R.id.toolbar_read_menu_item_modify -> {
                        ...
                        mainActivity.replaceFragment(
                            FragmentName.MODIFY_MEMO_FRAGMENT,
                            true,
                            true,
                            dataBundle
                        )
    ...
    fun settingMemoData() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            val work2 = async(Dispatchers.IO) {
                CategoryRepository.selectCategoryDataByCategoryIdx(
                    mainActivity,
                    readMemoModel.memoCategoryIdx
                )
            }
